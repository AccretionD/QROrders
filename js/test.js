function buildHtmlTable(myList) {
	...
	var states 	 = ["no_state","ig1_off","ig1_on","initial","key_off","key_on","freq_am","freq_fm","scanning","tuned","seeking","next","previous","playing","paused","stop","buffering","usb","hf(handsfree)","bt(bluetooth)","ams_on","ams_off","ams_am","ams_fm","ams_sdars","ams_cd","ams_mp3","ams_bluray"];
	...
	for (var i = 0 ; i < myList.length ; i++) {
		...
		for (var colIndex = 0 ; colIndex < columns.length ; colIndex++) {
			...
			if (columns[colIndex] == "state")     { cellValue = states[cellValue]; }
...
function showWeeklyData() {
	...
	function update() {
		showCount("#gncars",     "http://ec2-52-7-33-126.compute-1.amazonaws.com:3000/dtmpackagesv2/0","carid");
		showCount("#gninputs",   "http://ec2-52-7-33-126.compute-1.amazonaws.com:3000/dtmpackagesv2/0","all");
		showCount("#gncarmodels","http://ec2-52-7-33-126.compute-1.amazonaws.com:3000/dtmpackagesv2/0","carmodel");
...
function showListData() {
	function update() {
		showDataTable("http://ec2-52-7-33-126.compute-1.amazonaws.com:3000/dtmpackagesv1/JH23N1B452940");	
